    ...
    public class InstructorCoursesPageModel : PageModel
    {
                                               ...
                                               Instructor instructor)
        {
            ...
            var instructorCourses = new HashSet<int>(
                instructor.CourseAassignments.Select(c => c.CourseID));
            ...
            string[] selectedCourses, Instructor instructorToUpdate)
        {
            ...
            {
                instructorToUpdate.CourseAassignments = new List<CourseAssignment>();
                return;
            }

            var selectedCoursesHS = new HashSet<string>(selectedCourses);
            var instructorCourses = new HashSet<int>(
                instructorToUpdate.CourseAassignments.Select(c => c.Course.CourseID));
            foreach (var course in context.Courses)
            {
                if (selectedCoursesHS.Contains(course.CourseID.ToString()))
                {
                    ...
                    {
                        instructorToUpdate.CourseAassignments.Add(
